...
export const getServerSideProps = ServerSideSentryNextjsSDK.withSentryGSSP(__ORIG_GSSP__);
export const getStaticProps = ServerSideSentryNextjsSDK.withSentryGSProps(__ORIG_GSPROPS__);
export const getStaticPaths = ServerSideSentryNextjsSDK.withSentryGSPaths(__ORIG_GSPATHS__);
